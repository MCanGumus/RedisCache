...
namespace Redis.Sentinel.Services
{
    public class RedisService
    {
        ...
        static public async Task<IDatabase> RedisMasterDatabase()
        {
            ...
            foreach (System.Net.EndPoint endpoint in sentinelConn.GetEndPoints())
            {
                ...
                masterEndPoint = await server.SentinelGetMasterAddressByNameAsync("mymaster");//sentinel.conf dosyasındaki sentinelların master ismi...
